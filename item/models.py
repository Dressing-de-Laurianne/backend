...
TYPE_CHOICES = sorted([(t, t) for t in ['Shirt', 'Pants', 'Dress', 'Skirt', 'Jacket', 'Coat']])
COLOR_CHOICES = sorted([(c, c) for c in [
    'Black', 'White', 'Red', 'Blue', 'Green', 'Yellow', 'Pink', 'Purple', 'Brown', 'Grey', 'Orange', 'Beige'
]])
...
class Item(models.Model):
    ...
    color = models.CharField(choices=COLOR_CHOICES, default='Black', max_length=100, blank=True)
    ...
    hanger_id = models.OneToOneField('hanger.Hanger', on_delete=models.SET_NULL, related_name='items', blank=True, null=True, help_text="Hanger associated with this item. NULL is no hanger associated.")
